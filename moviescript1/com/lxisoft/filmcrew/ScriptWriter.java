...
{	
	...
	for(int i=0;i<x;i++)
	{
		...
		if(randomElement.equals("Stephen"))
		{
			...
			//hash.add(hero.get(0));
			//System.out.println("Stephen:"+hash);
			System.out.println(" ");
		...
		else if(randomElement.equals("Manju"))
		{
			...
			//set.add(heroine.get(0));
			//System.out.println("Manju:"+set);
			System.out.println(" ");
		...
		//ha.add(villain.get(0));
		//System.out.println("Bobby:"+ha);
		System.out.println(" ");
		...
		else
		{
			...
			//se.add(comedian.get(0));
			//System.out.println("Suraj:"+se);
			System.out.println(" ");
